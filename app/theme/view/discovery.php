...
<li class="breadcrumb-item active"><a href="<?php echo APP.'/discovery';?>"><?php echo __('Discovery');?></a></li>
</ol>
</nav>
...
<div class="mb-3">
<div class="text-24 text-white font-weight-bold"><?php echo __('Discovery');?></div>
...
<a href="<?php echo post($Listing['id'],$Listing['title'],$Listing['type']);?>" class="list-media">
...
<circle fill="none" stroke-width="1" cx="18" cy="18" r="16" stroke-dasharray="<?php echo round($Listing['imdb'] / 10 * 100);?> 100" stroke-dashoffset="0" transform="rotate(-90 18 18)"></circle></svg>
</div>
<?php } ?>
</div>
<?php } ?>
