<div class="app-section">
   <div class="app-heading">
      ...
      <a href="<?php echo APP.'/cursos';?>" class="all"><?php echo __('All');?></a>
   </div>
   <div class="row 
      row-cols-2 row-cols-md-6  <?php if(get($Settings,'data.scrollablehome','theme') == 0) { } else { ?>list-scrollable<?php } ?>">
      <?php
         ...
         <div class="list-movie">
            <a href="<?php echo post($Newest['id'],$Newest['self'],$Newest['type']);?>" class="list-media">
               ...
               <div class="list-media-attr">
                  ...
                  <div class="quality"><?php echo $Newest['quality'];?></div>
                  <?php } ?>
                  <?php if($Newest['imdb']) { ?>
                  <div class="imdb">
                     <span>
               ...
               <div class="media media-cover" data-src="<?php echo UPLOAD.'/cover/'.$Newest['image'];?>">
                  <?php if($Newest['mpaa']) { ?>
                  <div class="media-cover mpaa"><?php echo $Newest['mpaa'];?></div>
                  <?php } ?>
               </div>
            </a>
            <div class="list-caption">
               ...
               <?php if(empty($Newest['end_year'])) { ?>
               <div class="list-year"><?php echo $Newest['create_year'];?></div>
               <?php } ?><?php if(!empty($Newest['end_year'])) { ?>
               <div class="list-year"><?php echo $Newest['create_year'];?> - <?php echo $Newest['end_year'];?></div>
               <?php } ?>
            </div>
         </div>
      </div>
